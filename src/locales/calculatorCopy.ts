...
export const simpleCronGeneratorCopy = {
    es: {
        ...
        customPlaceholder: "Ej: 0 0/15 * 1/1 * ? *",
        emptyError: "Completa los campos para generar o explicar el cron.",
        cronError: "Escribe una expresión cron válida de 5, 6 o 7 partes.",
        hint: "Usa cron clásico de 5 partes o pega formatos con segundos/Quartz.",
        submit: "Generar cron",
        ...
        fiveFields: "5 campos",
        sixFields: "6 campos",
        sevenFields: "7 campos Quartz",
        macroFormat: "Macro",
        second: "Segundo",
        year: "Año",
        rulesNote: "Acepta cron estándar de 5 campos, cron con segundos y formato Quartz. Algunos servidores usan zona horaria del sistema.",
    ...
    en: {
        ...
        customPlaceholder: "Ex: 0 0/15 * 1/1 * ? *",
        emptyError: "Complete the fields to generate or explain the cron.",
        cronError: "Enter a valid 5-, 6-, or 7-part cron expression.",
        hint: "Use classic 5-part cron or paste formats with seconds/Quartz.",
        ...
        fiveFields: "5 fields",
        sixFields: "6 fields",
        sevenFields: "7-field Quartz",
        macroFormat: "Macro",
        second: "Second",
        year: "Year",
        rulesNote: "Supports standard 5-field cron, cron with seconds, and Quartz format. Some servers use the system timezone.",
    ...
    hi: {
        ...
        customPlaceholder: "\u0909\u0926\u093E\u0939\u0930\u0923: 0 0/15 * 1/1 * ? *",
        emptyError: "\u0915\u094D\u0930\u0949\u0928 \u0909\u0924\u094D\u092A\u0928\u094D\u0928 \u0915\u0930\u0928\u0947 \u092F\u093E \u0938\u092E\u091D\u093E\u0928\u0947 \u0915\u0947 \u0932\u093F\u090F \u092B\u093C\u0940\u0932\u094D\u0921 \u092A\u0942\u0930\u093E \u0915\u0930\u0947\u0902\u0964",
        cronError: "5, 6 \u092F\u093E 7-\u092D\u093E\u0917 \u0935\u093E\u0932\u093E \u0935\u0948\u0927 \u0915\u094D\u0930\u0949\u0928 \u090F\u0915\u094D\u0938\u092A\u094D\u0930\u0947\u0936\u0928 \u0926\u0930\u094D\u091C \u0915\u0930\u0947\u0902\u0964",
        hint: "\u0915\u094D\u0932\u093E\u0938\u093F\u0915 5-\u092D\u093E\u0917 \u0915\u094D\u0930\u0949\u0928 \u092F\u093E \u0938\u0947\u0915\u0902\u0921/Quartz \u0935\u093E\u0932\u093E \u092B\u0949\u0930\u094D\u092E\u0947\u091F \u092A\u0947\u0938\u094D\u091F \u0915\u0930\u0947\u0902\u0964",
        ...
        fiveFields: "5 \u092B\u093C\u0940\u0932\u094D\u0921",
        sixFields: "6 \u092B\u093C\u0940\u0932\u094D\u0921",
        sevenFields: "7-\u092B\u093C\u0940\u0932\u094D\u0921 Quartz",
        macroFormat: "\u092E\u0948\u0915\u094D\u0930\u094B",
        second: "\u0938\u0947\u0915\u0902\u0921",
        year: "\u0938\u093E\u0932",
        rulesNote: "\u092F\u0939 \u092E\u093E\u0928\u0915 5-\u092B\u093C\u0940\u0932\u094D\u0921 \u0915\u094D\u0930\u0949\u0928, \u0938\u0947\u0915\u0902\u0921 \u0935\u093E\u0932\u093E \u0915\u094D\u0930\u0949\u0928 \u0914\u0930 Quartz \u092B\u0949\u0930\u094D\u092E\u0947\u091F \u0938\u092E\u0930\u094D\u0925\u0928 \u0915\u0930\u0924\u093E \u0939\u0948\u0964 \u0915\u0941\u091B \u0938\u0930\u094D\u0935\u0930 \u0938\u093F\u0938\u094D\u091F\u092E \u091F\u093E\u0907\u092E\u091C\u093C\u094B\u0928 \u0915\u093E \u0909\u092A\u092F\u094B\u0917 \u0915\u0930\u0924\u0947 \u0939\u0948\u0902\u0964",
...
export const emailTemplateGeneratorCopy = {
    es: {
        kicker: "Documento",
        ...
        brandSection: "Marca y botón",
        autoUpdatePreview: "Actualizar vista automáticamente",
        autoUpdateDescription: "Cada cambio se refleja en el preview. Desactívalo si prefieres actualizar manualmente.",
        customSubject: "Asunto opcional",
        customSubjectPlaceholder: "Ej: Seguimiento a la propuesta comercial",
        recipientName: "Destinatario",
        recipientNamePlaceholder: "Ej: Laura, equipo de compras, cliente",
        senderName: "Firma",
        senderNamePlaceholder: "Ej: Sebastián Sossa",
        mainMessage: "Objetivo del correo",
        mainMessagePlaceholder: "Ej: confirmar si la propuesta enviada el viernes fue revisada y resolver cualquier duda pendiente.",
        cleanMainMessage: "Contenido del correo",
        cleanMainMessagePlaceholder: "Escribe aquí el contenido exacto que quieres dejar en la plantilla. No agregaremos saludos, cierres ni textos automáticos.",
        expectedAction: "Acción esperada",
        expectedActionPlaceholder: "Ej: responder con una fecha para reunirnos o confirmar aprobación.",
        tone: "Tono",
        length: "Extensión",
        layoutStyle: "Diseño",
        ...
        footerStyle: "Footer",
        emailWidth: "Ancho",
        brandName: "Marca o empresa",
        brandNamePlaceholder: "Ej: Tools Platforms",
        logoUrl: "URL del logo",
        logoUrlPlaceholder: "https://...",
        primaryColor: "Color principal",
        colorPlaceholder: "#4f46e5",
        backgroundColor: "Color de fondo",
        backgroundColorPlaceholder: "#f1f5f9",
        preheaderText: "Preheader",
        preheaderPlaceholder: "Texto oculto que algunos correos muestran como resumen.",
        buttonText: "Texto del botón",
        buttonTextPlaceholder: "Ej: Ver propuesta",
        buttonUrl: "URL del botón",
        buttonUrlPlaceholder: "https://...",
        footerText: "Pie del correo",
        footerTextPlaceholder: "Ej: Recibes este mensaje porque eres contacto de la empresa.",
        unsubscribeUrl: "URL para cancelar suscripción",
        unsubscribeUrlPlaceholder: "https://...",
        unsubscribeLabel: "Cancelar suscripción",
        textHint: "Genera una plantilla editable para copiarla en Gmail, Outlook o cualquier cliente de correo.",
        htmlHint: "Personaliza una plantilla HTML con estilos inline, cabecera, cuerpo, botón, footer y preview en vivo.",
        emptyError: "Escribe el objetivo del correo para generar la plantilla.",
        submitText: "Generar correo",
        submitHtml: "Generar HTML",
        updatePreview: "Actualizar preview",
        reset: "Restablecer",
        textReady: "Correo listo",
        htmlReady: "HTML listo",
        previewTitle: "Vista previa",
        ...
        copyBody: "Copiar texto",
        copyText: "Copiar texto",
        copied: "Copiado.",
        subjectCopied: "Asunto copiado.",
        bodyCopied: "Texto copiado.",
        ...
        close: "Cerrar",
        defaultTopic: "tu solicitud",
        cleanDefaultTopic: "contenido limpio",
        sampleObjective: "presentar una propuesta clara y fácil de revisar para avanzar con el siguiente paso.",
        sampleAction: "responder este correo con tus comentarios o confirmar una fecha para revisarlo.",
        pendingContent: "Describe el objetivo del correo",
        cleanPendingContent: "Escribe el contenido exacto",
        noBrand: "Sin marca",
        noButton: "Sin botón",
        textRulesNote: "El resultado queda fijo hasta que vuelvas a generar el correo.",
        htmlRulesNote: "El HTML usa tablas simples y estilos inline para mejorar compatibilidad con clientes de correo.",
        disclaimer: "Borrador automático. Ajusta nombres, datos sensibles, promesas comerciales y enlaces antes de enviarlo.",
        emptyTitle: "Tu plantilla aparecerá aquí",
        emptyTextDescription: "Completa el objetivo, elige tono y genera un correo listo para editar.",
        emptyHtmlDescription: "Completa el objetivo, agrega marca si quieres y genera una plantilla HTML con vista previa.",
        tones: {
            formal: "Formal",
            friendly: "Amable",
            direct: "Directo"
        ...
        headerStyles: {
            brandBand: "Banda de color",
            centered: "Logo centrado",
            split: "Logo y etiqueta",
            simple: "Título simple",
            dark: "Oscura",
            letterhead: "Membrete",
            boxed: "Tarjeta",
            announcement: "Anuncio",
            accentLine: "Línea lateral",
            none: "Sin cabecera"
        },
        bodyStyles: {
            clean: "Limpio",
            card: "Primer bloque destacado",
            editorial: "Editorial",
            highlight: "Con destacado"
        },
        buttonStyles: {
            pill: "Redondo",
            rounded: "Suave",
        ...
        greetings: {
            formal: (recipient: string) => recipient ? `Estimado/a ${recipient}:` : "Cordial saludo:",
            friendly: (recipient: string) => recipient ? `Hola, ${recipient}:` : "Hola:",
            direct: (recipient: string) => recipient ? `${recipient}:` : "Buen día:"
        },
        signOffs: {
            formal: "Atentamente,",
            friendly: "Quedo atento,",
            direct: "Saludos,"
        },
        actionParagraph: (action: string) => `Como siguiente paso, agradecería que pudieras ${action.charAt(0).toLocaleLowerCase()}${action.slice(1)}`,
        closingParagraphs: {
            formal: "Agradezco de antemano tu atención y quedo disponible para ampliar cualquier información que sea necesaria.",
            friendly: "Gracias por revisar este mensaje. Quedo atento a tus comentarios para avanzar sin fricción.",
            direct: "Quedo pendiente de tu respuesta para continuar con el proceso."
        },
        emailTypes: {
            request: {
                label: "Solicitud",
                subject: (topic: string) => `Solicitud: ${topic}`,
                opening: (message: string) => `Te escribo para solicitar apoyo con lo siguiente: ${message}`,
                context: "La idea es dejar claro el contexto, evitar confusiones y avanzar con una respuesta concreta.",
                defaultAction: "Si necesitas información adicional, puedo enviarla para facilitar la revisión.",
                detailed: "Incluyo esta solicitud de forma ordenada para que puedas evaluarla con calma y definir el mejor siguiente paso."
            },
            followUp: {
                label: "Seguimiento",
                subject: (topic: string) => `Seguimiento: ${topic}`,
                opening: (message: string) => `Quería hacer seguimiento a este tema: ${message}`,
                context: "El objetivo es confirmar el estado actual y saber si hay algo pendiente de mi parte.",
                defaultAction: "Cuando tengas oportunidad, agradecería una actualización para continuar.",
                detailed: "Si ya existe una decisión o un cambio de prioridad, también me sirve conocerlo para ajustar los próximos pasos."
            },
            proposal: {
                label: "Propuesta",
                subject: (topic: string) => `Propuesta: ${topic}`,
                opening: (message: string) => `Comparto esta propuesta para atender el siguiente objetivo: ${message}`,
                context: "La propuesta busca aportar una solución clara, práctica y fácil de revisar.",
                defaultAction: "Si te parece útil, podemos coordinar una llamada corta para revisar detalles.",
                detailed: "Quedo disponible para ajustar alcance, tiempos o condiciones según lo que necesites priorizar."
            },
            reminder: {
                label: "Recordatorio",
                subject: (topic: string) => `Recordatorio: ${topic}`,
                opening: (message: string) => `Te escribo como recordatorio sobre este pendiente: ${message}`,
                context: "Lo envío para que el tema no se pierda y podamos mantenerlo en movimiento.",
                defaultAction: "Agradezco que me confirmes si sigue vigente o si debemos actualizarlo.",
                detailed: "Si hay un cambio de fecha, responsable o prioridad, puedo adaptarme y reorganizar el seguimiento."
            },
            thanks: {
                label: "Agradecimiento",
                subject: (topic: string) => `Gracias por ${topic}`,
                opening: (message: string) => `Quiero agradecer por lo siguiente: ${message}`,
                context: "Valoro el tiempo, la disposición y el apoyo brindado durante el proceso.",
                defaultAction: "Quedo atento por si puedo apoyar en algo adicional.",
                detailed: "Este mensaje busca dejar constancia del agradecimiento y mantener una comunicación cercana y profesional."
            },
            apology: {
                label: "Disculpa",
                subject: (topic: string) => `Disculpa por ${topic}`,
                opening: (message: string) => `Te escribo para ofrecer una disculpa por esta situación: ${message}`,
                context: "Entiendo la importancia de manejar el tema con claridad y responsabilidad.",
                defaultAction: "Haré lo necesario para corregirlo y evitar que vuelva a ocurrir.",
                detailed: "Agradezco tu comprensión y quedo atento a cualquier indicación adicional para cerrar el tema correctamente."
            },
            clean: {
                label: "Limpio",
                subject: (topic: string) => `Correo: ${topic}`,
                opening: (message: string) => message,
                context: "",
                defaultAction: "",
                detailed: ""
            }
    ...
    en: {
        ...
        footerSection: "Footer",
        brandSection: "Brand and button",
        autoUpdatePreview: "Update preview automatically",
        autoUpdateDescription: "Every change updates the preview. Turn it off if you prefer manual updates.",
        customSubject: "Optional subject",
        customSubjectPlaceholder: "E.g. Follow-up on the business proposal",
        recipientName: "Recipient",
        recipientNamePlaceholder: "E.g. Laura, purchasing team, customer",
        senderName: "Signature",
        senderNamePlaceholder: "E.g. Sebastian Sossa",
        mainMessage: "Email objective",
        mainMessagePlaceholder: "E.g. confirm whether the proposal sent on Friday was reviewed and answer any pending questions.",
        cleanMainMessage: "Email content",
        cleanMainMessagePlaceholder: "Write the exact content you want in the template. We will not add greetings, closings, or automatic text.",
        expectedAction: "Expected action",
        expectedActionPlaceholder: "E.g. reply with a meeting date or confirm approval.",
        tone: "Tone",
        length: "Length",
        layoutStyle: "Design",
        headerStyle: "Header",
        ...
        brandNamePlaceholder: "E.g. Tools Platforms",
        logoUrl: "Logo URL",
        logoUrlPlaceholder: "https://...",
        ...
        backgroundColorPlaceholder: "#f1f5f9",
        preheaderText: "Preheader",
        preheaderPlaceholder: "Hidden text some inboxes show as a summary.",
        buttonText: "Button text",
        buttonTextPlaceholder: "E.g. View proposal",
        buttonUrl: "Button URL",
        buttonUrlPlaceholder: "https://...",
        footerText: "Email footer",
        footerTextPlaceholder: "E.g. You receive this message because you are a company contact.",
        unsubscribeUrl: "Unsubscribe URL",
        unsubscribeUrlPlaceholder: "https://...",
        unsubscribeLabel: "Unsubscribe",
        textHint: "Generate an editable template to copy into Gmail, Outlook, or any email client.",
        htmlHint: "Customize an HTML template with inline styles, header, body, button, footer, and live preview.",
        emptyError: "Write the email objective to generate the template.",
        submitText: "Generate email",
        submitHtml: "Generate HTML",
        updatePreview: "Update preview",
        reset: "Reset",
        textReady: "Email ready",
        ...
        close: "Close",
        defaultTopic: "your request",
        cleanDefaultTopic: "clean content",
        sampleObjective: "present a clear proposal that is easy to review and helps move to the next step.",
        sampleAction: "reply to this email with your comments or confirm a time to review it.",
        pendingContent: "Describe the email objective",
        cleanPendingContent: "Write the exact content",
        noBrand: "No brand",
        noButton: "No button",
        textRulesNote: "The result stays fixed until you generate the email again.",
        htmlRulesNote: "The HTML uses simple tables and inline styles to improve compatibility with email clients.",
        disclaimer: "Automatic draft. Review names, sensitive data, commercial promises, and links before sending it.",
        emptyTitle: "Your template will appear here",
        emptyTextDescription: "Complete the objective, choose a tone, and generate an email ready to edit.",
        emptyHtmlDescription: "Complete the objective, add branding if needed, and generate an HTML template with preview.",
        tones: {
            formal: "Formal",
            friendly: "Friendly",
            direct: "Direct"
        ...
        headerStyles: {
            brandBand: "Color band",
            centered: "Centered logo",
            split: "Logo and label",
            simple: "Simple title",
            dark: "Dark",
            letterhead: "Letterhead",
            boxed: "Card",
            announcement: "Announcement",
            accentLine: "Side line",
            none: "No header"
        },
        bodyStyles: {
            clean: "Clean",
            card: "Featured first block",
            editorial: "Editorial",
        ...
        greetings: {
            formal: (recipient: string) => recipient ? `Dear ${recipient},` : "Hello,",
            friendly: (recipient: string) => recipient ? `Hi ${recipient},` : "Hi,",
            direct: (recipient: string) => recipient ? `${recipient},` : "Hello,"
        },
        signOffs: {
            formal: "Sincerely,",
            friendly: "Thanks,",
        ...
        actionParagraph: (action: string) => `As a next step, I would appreciate it if you could ${action.charAt(0).toLocaleLowerCase()}${action.slice(1)}`,
        closingParagraphs: {
            formal: "Thank you in advance for your attention. I remain available to provide any additional information needed.",
            friendly: "Thanks for reviewing this message. I will stay attentive to your comments so we can move forward smoothly.",
            direct: "I will wait for your response so we can continue with the process."
        },
        emailTypes: {
            request: {
                label: "Request",
                subject: (topic: string) => `Request: ${topic}`,
                opening: (message: string) => `I am writing to request support with the following: ${message}`,
                context: "The goal is to make the context clear, avoid confusion, and move forward with a concrete answer.",
                defaultAction: "If you need additional information, I can send it to make the review easier.",
                detailed: "I am sharing this request in an organized way so you can evaluate it calmly and define the best next step."
            },
            followUp: {
                label: "Follow-up",
                subject: (topic: string) => `Follow-up: ${topic}`,
                opening: (message: string) => `I wanted to follow up on this topic: ${message}`,
                context: "The objective is to confirm the current status and know whether anything is pending from my side.",
                defaultAction: "When you have a chance, I would appreciate an update so we can continue.",
                detailed: "If there is already a decision or a change in priority, that would also help me adjust the next steps."
            },
            proposal: {
                label: "Proposal",
                subject: (topic: string) => `Proposal: ${topic}`,
                opening: (message: string) => `I am sharing this proposal to address the following objective: ${message}`,
                context: "The proposal aims to provide a clear, practical, and easy-to-review solution.",
                defaultAction: "If it looks useful, we can schedule a short call to review the details.",
                detailed: "I am available to adjust scope, timing, or conditions depending on what you need to prioritize."
            },
            reminder: {
                label: "Reminder",
                subject: (topic: string) => `Reminder: ${topic}`,
                opening: (message: string) => `I am writing as a reminder about this pending topic: ${message}`,
                context: "I am sending it so the topic stays visible and we can keep it moving.",
                defaultAction: "I would appreciate confirmation on whether it is still active or should be updated.",
                detailed: "If there is a change in date, owner, or priority, I can adapt and reorganize the follow-up."
            },
            thanks: {
                label: "Thank-you",
                subject: (topic: string) => `Thank you for ${topic}`,
                opening: (message: string) => `I would like to thank you for the following: ${message}`,
                context: "I value the time, willingness, and support provided during the process.",
                defaultAction: "I remain available in case I can support anything else.",
                detailed: "This message is meant to acknowledge the support and keep communication close and professional."
            },
            apology: {
                label: "Apology",
                subject: (topic: string) => `Apology for ${topic}`,
                opening: (message: string) => `I am writing to apologize for this situation: ${message}`,
                context: "I understand the importance of handling this clearly and responsibly.",
                defaultAction: "I will do what is necessary to correct it and prevent it from happening again.",
                detailed: "Thank you for your understanding. I remain attentive to any additional guidance needed to close this properly."
            },
            clean: {
                label: "Clean",
                subject: (topic: string) => `Email: ${topic}`,
                opening: (message: string) => message,
                context: "",
                defaultAction: "",
                detailed: ""
    ...
    hi: {
        designSection: "डिज़ाइन",
        headerSection: "हेडर",
        bodySection: "मुख्य भाग",
        buttonSection: "बटन",
        footerSection: "फुटर",
        autoUpdatePreview: "पूर्वावलोकन अपने आप अपडेट करें",
        autoUpdateDescription: "हर बदलाव पूर्वावलोकन में दिखेगा। हाथ से अपडेट करना चाहें तो इसे बंद करें।",
        layoutStyle: "डिज़ाइन",
        headerStyle: "हेडर",
        bodyStyle: "मुख्य भाग",
        buttonStyle: "बटन",
        ...
        backgroundColorPlaceholder: "#f1f5f9",
        preheaderText: "इनबॉक्स सारांश",
        preheaderPlaceholder: "इनबॉक्स में सारांश की तरह दिखने वाला छिपा टेक्स्ट.",
        unsubscribeUrl: "सदस्यता समाप्ति लिंक",
        unsubscribeUrlPlaceholder: "https://...",
        unsubscribeLabel: "सदस्यता समाप्त करें",
        updatePreview: "पूर्वावलोकन अपडेट करें",
        downloadHtml: "HTML डाउनलोड करें",
        customizeTitle: "कस्टमाइज़",
        copyText: "टेक्स्ट कॉपी करें",
        textCopied: "टेक्स्ट कॉपी हो गया.",
        htmlDownloaded: "HTML डाउनलोड हो गया.",
        sampleObjective: "एक स्पष्ट प्रस्ताव प्रस्तुत करना जिसे देखना आसान हो और अगला कदम तय हो सके.",
        sampleAction: "इस ईमेल का जवाब अपनी टिप्पणी के साथ दें या समीक्षा का समय तय करें.",
        noButton: "बिना बटन",
        layoutStyles: {
        ...
        contentSection: "सामग्री",
        styleSection: "शैली",
        brandSection: "ब्रांड और बटन",
        customSubject: "वैकल्पिक विषय",
        customSubjectPlaceholder: "उदा. व्यावसायिक प्रस्ताव पर फॉलो-अप",
        recipientName: "प्राप्तकर्ता",
        recipientNamePlaceholder: "उदा. लौरा, खरीदारी टीम, ग्राहक",
        senderName: "हस्ताक्षर",
        senderNamePlaceholder: "उदा. सेबास्टियन सोसा",
        mainMessage: "ईमेल का उद्देश्य",
        mainMessagePlaceholder: "उदा. शुक्रवार को भेजे गए प्रस्ताव की समीक्षा की पुष्टि करना और बाकी सवालों का जवाब देना.",
        cleanMainMessage: "ईमेल सामग्री",
        cleanMainMessagePlaceholder: "टेम्पलेट में जो सटीक सामग्री चाहिए, उसे यहां लिखें. हम अभिवादन, समापन या अपने-आप जुड़ने वाला टेक्स्ट नहीं जोड़ेंगे.",
        expectedAction: "अपेक्षित कार्रवाई",
        expectedActionPlaceholder: "उदा. मीटिंग की तारीख बताना या स्वीकृति की पुष्टि करना.",
        tone: "टोन",
        length: "लंबाई",
        brandName: "ब्रांड या कंपनी",
        brandNamePlaceholder: "उदा. Tools Platforms",
        logoUrl: "लोगो लिंक",
        logoUrlPlaceholder: "https://...",
        primaryColor: "मुख्य रंग",
        colorPlaceholder: "#4f46e5",
        buttonText: "बटन टेक्स्ट",
        buttonTextPlaceholder: "उदा. प्रस्ताव देखें",
        buttonUrl: "बटन लिंक",
        buttonUrlPlaceholder: "https://...",
        footerText: "ईमेल फुटर",
        footerTextPlaceholder: "उदा. आपको यह संदेश इसलिए मिला है क्योंकि आप कंपनी संपर्क हैं.",
        textHint: "Gmail, Outlook या किसी भी ईमेल क्लाइंट में कॉपी करने के लिए संपादन योग्य टेम्पलेट बनाएं.",
        htmlHint: "इनलाइन शैली, पूर्वावलोकन और कॉपी करने योग्य कोड वाला HTML ईमेल बनाएं.",
        emptyError: "टेम्पलेट बनाने के लिए ईमेल का उद्देश्य लिखें.",
        submitText: "ईमेल बनाएं",
        submitHtml: "HTML बनाएं",
        reset: "रीसेट",
        textReady: "ईमेल तैयार",
        htmlReady: "HTML तैयार",
        ...
        copyBody: "टेक्स्ट कॉपी करें",
        copied: "कॉपी हो गया.",
        subjectCopied: "विषय कॉपी हो गया.",
        bodyCopied: "टेक्स्ट कॉपी हो गया.",
        copyFailed: "हम इसे अपने आप कॉपी नहीं कर सके.",
        moreOptions: "अधिक विकल्प",
        outputFormat: "फ़ॉर्मेट",
        words: "शब्द",
        characters: "अक्षर",
        htmlSource: "HTML कोड",
        close: "बंद करें",
        defaultTopic: "आपका अनुरोध",
        cleanDefaultTopic: "साफ सामग्री",
        pendingContent: "ईमेल का उद्देश्य लिखें",
        cleanPendingContent: "सटीक सामग्री लिखें",
        noBrand: "बिना ब्रांड",
        textRulesNote: "परिणाम तब तक स्थिर रहता है जब तक आप ईमेल दोबारा नहीं बनाते.",
        htmlRulesNote: "HTML ईमेल क्लाइंट के साथ बेहतर संगतता के लिए इनलाइन शैली का उपयोग करता है.",
        disclaimer: "स्वचालित ड्राफ्ट. भेजने से पहले नाम, संवेदनशील डेटा, व्यावसायिक वादे और लिंक जांचें.",
        emptyTitle: "आपका टेम्पलेट यहां दिखाई देगा",
        emptyTextDescription: "उद्देश्य पूरा करें, टोन चुनें और संपादन योग्य ईमेल बनाएं.",
        emptyHtmlDescription: "उद्देश्य पूरा करें, चाहें तो ब्रांड जोड़ें और पूर्वावलोकन वाला HTML टेम्पलेट बनाएं.",
        tones: {
            formal: "औपचारिक",
            friendly: "मित्रवत",
            direct: "सीधा"
        ...
        greetings: {
            formal: (recipient: string) => recipient ? `प्रिय ${recipient},` : "नमस्कार,",
            friendly: (recipient: string) => recipient ? `नमस्ते ${recipient},` : "नमस्ते,",
            direct: (recipient: string) => recipient ? `${recipient},` : "नमस्कार,"
        },
        signOffs: {
            formal: "सादर,",
            friendly: "धन्यवाद,",
        ...
        actionParagraph: (action: string) => `अगले कदम के रूप में, कृपया ${action.charAt(0).toLocaleLowerCase()}${action.slice(1)}`,
        closingParagraphs: {
            formal: "आपके समय के लिए धन्यवाद. जरूरत होने पर मैं अतिरिक्त जानकारी देने के लिए उपलब्ध हूँ.",
            friendly: "इस संदेश की समीक्षा के लिए धन्यवाद. आगे बढ़ने के लिए मैं आपके जवाब की प्रतीक्षा करूँगा.",
            direct: "प्रक्रिया जारी रखने के लिए मैं आपके उत्तर की प्रतीक्षा करूँगा."
        },
        emailTypes: {
            request: {
                label: "अनुरोध",
                subject: (topic: string) => `अनुरोध: ${topic}`,
                opening: (message: string) => `मैं निम्न विषय पर सहायता का अनुरोध करने के लिए लिख रहा/रही हूँ: ${message}`,
                context: "उद्देश्य संदर्भ को स्पष्ट रखना, भ्रम से बचना और ठोस उत्तर के साथ आगे बढ़ना है.",
                defaultAction: "अगर अतिरिक्त जानकारी चाहिए, तो मैं समीक्षा आसान बनाने के लिए भेज सकता/सकती हूँ.",
                detailed: "मैं यह अनुरोध व्यवस्थित रूप से साझा कर रहा/रही हूँ ताकि आप इसे आराम से देख सकें और अगला कदम तय कर सकें."
            },
            followUp: {
                label: "फॉलो-अप",
                subject: (topic: string) => `फॉलो-अप: ${topic}`,
                opening: (message: string) => `मैं इस विषय पर फॉलो-अप करना चाहता/चाहती हूँ: ${message}`,
                context: "उद्देश्य वर्तमान स्थिति की पुष्टि करना और यह जानना है कि मेरी ओर से कुछ बाकी है या नहीं.",
                defaultAction: "समय मिलने पर कृपया अपडेट साझा करें ताकि हम आगे बढ़ सकें.",
                detailed: "अगर कोई निर्णय हो चुका है या प्राथमिकता बदल गई है, तो वह जानकारी भी अगले कदम समायोजित करने में मदद करेगी."
            },
            proposal: {
                label: "प्रस्ताव",
                subject: (topic: string) => `प्रस्ताव: ${topic}`,
                opening: (message: string) => `मैं यह प्रस्ताव इस उद्देश्य के लिए साझा कर रहा/रही हूँ: ${message}`,
                context: "प्रस्ताव का लक्ष्य एक स्पष्ट, व्यावहारिक और आसानी से समीक्षा योग्य समाधान देना है.",
                defaultAction: "अगर यह उपयोगी लगे, तो हम विवरण देखने के लिए छोटी कॉल रख सकते हैं.",
                detailed: "आपकी प्राथमिकता के अनुसार दायरा, समय या शर्तें समायोजित करने के लिए मैं उपलब्ध हूँ."
            },
            reminder: {
                label: "रिमाइंडर",
                subject: (topic: string) => `रिमाइंडर: ${topic}`,
                opening: (message: string) => `मैं इस लंबित विषय की याद दिलाने के लिए लिख रहा/रही हूँ: ${message}`,
                context: "मैं इसे इसलिए भेज रहा/रही हूँ ताकि विषय नजर में रहे और आगे बढ़ सके.",
                defaultAction: "कृपया पुष्टि करें कि यह अभी भी सक्रिय है या इसे अपडेट करना चाहिए.",
                detailed: "अगर तारीख, जिम्मेदार व्यक्ति या प्राथमिकता बदली है, तो मैं फॉलो-अप को समायोजित कर सकता/सकती हूँ."
            },
            thanks: {
                label: "धन्यवाद",
                subject: (topic: string) => `${topic} के लिए धन्यवाद`,
                opening: (message: string) => `मैं निम्न बात के लिए धन्यवाद देना चाहता/चाहती हूँ: ${message}`,
                context: "मैं प्रक्रिया के दौरान दिए गए समय, सहयोग और समर्थन की सराहना करता/करती हूँ.",
                defaultAction: "अगर मैं किसी और चीज में मदद कर सकता/सकती हूँ, तो उपलब्ध हूँ.",
                detailed: "यह संदेश सहयोग को स्वीकार करने और पेशेवर संवाद बनाए रखने के लिए है."
            },
            apology: {
                label: "क्षमा",
                subject: (topic: string) => `${topic} के लिए क्षमा`,
                opening: (message: string) => `मैं इस स्थिति के लिए क्षमा मांगने के लिए लिख रहा/रही हूँ: ${message}`,
                context: "मैं समझता/समझती हूँ कि इसे स्पष्टता और जिम्मेदारी के साथ संभालना जरूरी है.",
                defaultAction: "मैं इसे सुधारने और दोबारा न होने देने के लिए जरूरी कदम उठाऊंगा/उठाऊंगी.",
                detailed: "आपकी समझ के लिए धन्यवाद. विषय को सही तरीके से बंद करने के लिए मैं किसी भी अतिरिक्त निर्देश पर ध्यान दूँगा/दूँगी."
            },
            clean: {
                label: "साफ",
                subject: (topic: string) => `ईमेल: ${topic}`,
                opening: (message: string) => message,
                context: "",
                defaultAction: "",
                detailed: ""
