...
const relatedToolIds: Record<string, string[]> = {
  ...
  "days-between-dates": ["weeks-between-dates", "days-until-date", "exact-age"],
  "weeks-between-dates": ["days-between-dates", "days-until-date", "exact-age"],
  "exact-age": ["days-between-dates", "weeks-between-dates", "days-until-date"],
  ...
  "random-text-generator": ["alphabetical-line-sorter", "text-case-converter", "remove-extra-spaces"],
  "alphabetical-line-sorter": ["duplicate-counter", "remove-extra-spaces", "text-case-converter"],
  "percentage-calculator": ["unit-converter", "salary-increase", "loan-payment"],
