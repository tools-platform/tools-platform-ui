      ...
      <form className="calculator-card" onSubmit={handleSubmit}>
        ...
        <div className="form-grid">
          <label className="field">
            ...
            />
            <small>Escribe 24 si la tasa anual es del 24%.</small>
          </label>
          ...
          <label className="field">
            <span className="field-label">
              ...
              <span className="info-tooltip">
                <Info size={15} strokeWidth={2.1} />
                <span role="tooltip">
                  Simple: el interés se calcula siempre sobre el dinero inicial. Compuesto:
                  los intereses se van sumando al saldo y también generan intereses.
                </span>
              </span>
            </span>
