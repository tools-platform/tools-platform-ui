...
const copy = {
  ...
  en: {
    ...
    solidarityExplanationTitle: "What is the solidarity pension fund?",
    solidarityExplanation:
    ...
    <div className="calculator-layout">
      <form className="calculator-card" onSubmit={handleSubmit}>
        ...
        <label className="toggle-field toggle-field--compact">
          ...
          <span><strong>{text.showSolidarityFund}</strong><small>{text.showSolidarityFundHelp}</small></span>
        </label>

        <div className="explain-note explain-note--form">
          <Info size={18} strokeWidth={2.1} />
          <p><strong>{text.solidarityExplanationTitle}</strong>{text.solidarityExplanation}</p>
        </div>
